...
/**
 * Google מאפשר לנו לקבוע את מזהה האירוע מראש, ולכן מניעת הכפילות היא מבנית ולא
 * תלוית חיפוש: אותו פריט תמיד ייתן אותו מזהה, וניסיון שני יידחה בצד Google.
 * המזהה חייב להיות base32hex — האותיות a–v והספרות 0–9 בלבד.
 */
